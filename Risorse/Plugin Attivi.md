...
- **Search**: cerca nomi, luoghi e frasi nel vault.
- **Backlinks**: guarda dove viene citata una nota.
- **Graph**: utile per vedere relazioni tra mondo, PNG e luoghi.
- **Canvas**: utile per mappe relazionali, fronti e fazioni.
- **Bookmarks**: salva le pagine piu usate.
- **Properties**: mostra e modifica i campi delle note.
- **Page Preview**: anteprima rapida passando sui link.
