...
const RUNTIME_EXPORTS_SOURCE = "Dev/TemplateFactory/modules/runtime_exports.yaml";
const errors = [];
...
const RUNTIME_RENDER_CONTRACT_SOURCE = String(RUNTIME_EXPORTS.render_contract ?? "Dev/TemplateFactory/modules/runtime_render_contract.yaml").trim();
...
const RUNTIME_DATAVIEW_CONTRACT_SOURCE = String(RUNTIME_RENDER_CONTRACT.dataview_contract ?? "Dev/TemplateFactory/modules/runtime_dataview_contract.yaml").trim();
