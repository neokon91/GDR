...
const GENERATED_LOCAL_DIRS = [
    ...
    ".pytest_cache",
    "__pycache__",
    "Dev/TemplateFactory/tools/__pycache__",
...
const FORBIDDEN_AUTOMATION_TOOL_PREFIXES = ["audit_", "check_", "generate_", "import_", "render_", "release_", "template_factory_"];
const FORBIDDEN_AUTOMATION_TOOL_FILES = new Set([
    "cockpit_renderer_utils.js",
    "node_utils.js",
    "repo_hygiene.js",
...
const FORBIDDEN_TRACKED_GENERATED_FILES = [
    ...
    "Risorse/Come Usare I Clock.md",
    "Risorse/Controllo Vault.md",
    "Risorse/Creazione Guidata Entità.md",
    "Risorse/Excalidraw Per GDR.md",
    "Risorse/FAQ.md",
    "Risorse/Fronti Di Campagna.md",
    "Risorse/Guida DM.md",
    ...
    "Risorse/Media Scene.md",
    "Risorse/Opportunità Di Avventura.md",
    ...
    "Risorse/Tabelle/Tabelle.md",
    "Risorse/Tabelle/Worldbuilding Generatori.md",
    "Risorse/Task DM.md",
    "Risorse/Worldbuilding Profondo.md",
...
const automationRoot = repoPath(ROOT, "z.automazioni");
if (fs.existsSync(automationRoot)) {
    for (const entry of fs.readdirSync(automationRoot, { withFileTypes: true })) {
        if (!entry.isFile()) continue;
        if (
            FORBIDDEN_AUTOMATION_TOOL_FILES.has(entry.name)
            || FORBIDDEN_AUTOMATION_TOOL_PREFIXES.some(prefix => entry.name.startsWith(prefix))
        ) {
            errors.push(`z.automazioni/${entry.name}: tooling dev vietato nel runtime vault; usare Dev/TemplateFactory/tools/`);
        }
    }
}
