...
const azgaar = run("node", [
    "Dev/TemplateFactory/tools/import_azgaar_geojson.js",
    azgaarFixture,
    "--world",
    "Mondo Test",
    "--dry-run"
...
const watabouCity = run("node", [
    "Dev/TemplateFactory/tools/import_watabou_city.js",
    watabouCityFixture,
    "--world",
    "Mondo Test",
    "--dry-run"
...
const watabouDungeon = run("node", [
    "Dev/TemplateFactory/tools/import_watabou_dungeon.js",
...
const dispatch = run("node", [
    "Dev/TemplateFactory/tools/import_map.js",
    "azgaar",
    azgaarFixture,
    "--world",
    "Mondo Test",
