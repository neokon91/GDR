...
- Confine release: `release_boundary.yaml` dichiara materiale richiesto/vietato e marker riservati; `check:release-artifact` lo usa per bloccare leak dev-only o FantasyWorld nella release pulita.
