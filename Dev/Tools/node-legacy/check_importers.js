...
const azgaarFixture = path.join("Dev", "Examples", "importers", "azgaar_sample.geojson");
const watabouCityFixture = path.join("Dev", "Examples", "importers", "watabou_city_sample.json");
const watabouDungeonFixture = path.join("Dev", "Examples", "importers", "watabou_dungeon_sample.json");
