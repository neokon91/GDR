...
DEFAULT_REPORT = GENERATED / "migration_audit.md"
...
def render_markdown(rows: list[dict]) -> str:
    lines = [
        ...
        "",
        "Questo report confronta le preview generate da `Dev/Source` con i template reali in `z.modelli`. Non modifica i template reali.",
        "",
        "## Sintesi",
        "",
