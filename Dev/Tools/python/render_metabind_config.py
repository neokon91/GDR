...
ROOT = Path.cwd()
SOURCE = ROOT / "Dev" / "Source" / "YAML" / "json" / "metabind_config.yaml"
INPUTS_SOURCE = ROOT / "Dev" / "Source" / "YAML" / "json" / "metabind_inputs.yaml"
BUTTONS_SOURCE = ROOT / "Dev" / "Source" / "YAML" / "json" / "metabind_buttons.yaml"
