...
async function create_entity(tp, templateId = "") {
  ...
  if (category === "creatura") {
    // I dati 5e vivono nel blocco ```statblock``` della nota (come negli esempi);
    // "inline" registra quel blocco nel bestiario per l'Initiative Tracker.
    frontmatter.statblock = "inline";
  }
