---
id: demo-custodi-e-brumafonda
nome: "Demo - Custodi e Brumafonda"
categoria: relazione
tipo: rivalità
stato: in gioco
canonico: true
...
scelte:
  ...
  - consegnare un frammento ai Custodi
rischi:
  - Odran viene interrogato pubblicamente
  - la valle si divide tra sicurezza e libertà
indizi:
  - sigilli freschi sulle corde delle campane
segreti:
  - Sella sa che il coprifuoco non chiude la Soglia, ma le dà tempo per trovare i frammenti.
---

# Demo - Custodi e Brumafonda

> [!scena] Relazione viva
> Dopo la Seconda Nebbia, i Custodi non sono solo una fazione: sono il potere che decide chi passa, chi parla e chi custodisce i frammenti.

> [!timer] Prossima pressione
> Il ponte viene chiuso prima della prossima alba. La sessione successiva parte con una scelta politica, non solo con un incontro.
