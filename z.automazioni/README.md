...
| `check_obsidian_user_acceptance.js` | Harness live: apre una release stabile in Obsidian con profilo persistente, verifica pagine first-run, workflow Nuovo Mondo e persistenza. `check:obsidian-first-run` e l'unico comando che resetta profilo e accetta prompt. |
