...
> `BUTTON[avanza-mondo]` (fa girare il mondo: avanza i Fronti, scatena i pieni, propaga le onde) · `BUTTON[apri-calendario]` (calendario del mondo · timeline) · `BUTTON[world-board]` (Canvas «a colpo d'occhio»)
