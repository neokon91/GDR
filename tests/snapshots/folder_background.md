...
from ""
where categoria = "background" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "background" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "background" and stato = "bozza"
