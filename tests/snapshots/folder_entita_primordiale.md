...
from ""
where categoria = "entita_primordiale" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "entita_primordiale" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "entita_primordiale" and stato = "bozza"
