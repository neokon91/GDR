...
Il blocco qui sotto è il flusso **legacy** (Initiative Tracker + Fantasy Statblocks): aggiungi
le creature per nome con `- <numero>: <Nome>`; un alleato con `- <Nome>, ally`; `players: true`
include il gruppo.
