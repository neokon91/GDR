...
from ""
where categoria = "incantesimo" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "incantesimo" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "incantesimo" and stato = "bozza"
