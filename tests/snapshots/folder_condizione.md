...
from ""
where categoria = "condizione" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "condizione" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "condizione" and stato = "bozza"
