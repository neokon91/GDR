...
from ""
where categoria = "sistema_magico" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "sistema_magico" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "sistema_magico" and stato = "bozza"
