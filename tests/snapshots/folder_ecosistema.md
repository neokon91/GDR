...
from ""
where categoria = "ecosistema" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "ecosistema" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "ecosistema" and stato = "bozza"
