...
from ""
where categoria = "albero_evolutivo" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "albero_evolutivo" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "albero_evolutivo" and stato = "bozza"
