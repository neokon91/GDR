...
from ""
where categoria = "istituzione" and stato != "archiviata"
sort file.name asc
```
...
from ""
where categoria = "istituzione" and pressione >= 5 and stato != "archiviata"
sort pressione desc
limit 8
```
...
list
from ""
where categoria = "istituzione" and stato = "bozza"
