...
actions: 
- name: "Multiattacco"
  desc: "Il mezzodrago effettua due attacchi Artiglio."
- name: "Artiglio"
  desc: "*Tiro per colpire in mischia:* +7, portata 3 m. *Colpito:* 6 (1d4 + 4) danni taglienti più 7 (2d6) danni del tipo scelto per il tratto Origine draconica."
- name: "Soffio del drago (ricarica 5-6)"
  desc: "*Tiro salvezza su Destrezza:* CD 14, tutte le creature in un cono di 9 metri. *Fallimento:* 28 (8d6) danni del tipo scelto per il tratto Origine draconica. *Successo:* danni dimezzati."
bonus_actions: 
- name: "Balzo"
  desc: "Il mezzodrago salta fino a 9 metri usando 3 metri di movimento."
reactions: []
legendary_actions: []
lair_actions: []
tipo_creatura: "Drago"
