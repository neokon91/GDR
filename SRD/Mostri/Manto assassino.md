...
actions: 
- name: "Multiattacco"
  desc: "Il manto assassino effettua un attacco Avvinghiare e due attacchi Coda."
- name: "Avvinghiare"
...
- name: "Coda"
  desc: "*Tiro per colpire in mischia:* +6, portata 3 m. *Colpito:* 8 (1d10 + 3) danni taglienti."
bonus_actions: 
- name: "Allucinazioni (ricarica dopo un riposo breve o lungo)"
  desc: "Il manto assassino lancia l'incantesimo immagine speculare senza bisogno di componenti, utilizzando Saggezza come caratteristica da incantatore. L'incantesimo termina in anticipo se il manto assassino inizia o termina il proprio turno mentre è esposto alla luce intensa."
- name: "Gemito"
  desc: "*Tiro salvezza su Saggezza:* CD 13, tutte le creature in un'emanazione di 18 metri di cui il manto assassino è il punto di origine. *Fallimento:* il bersaglio è spaventato fino al termine del turno successivo del manto assassino. *Successo:* il bersaglio è immune al Gemito di questo manto assassino per le 24 ore successive."
reactions: []
legendary_actions: []
lair_actions: []
