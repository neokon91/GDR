...
actions: 
- name: "Multiattacco"
  desc: "Lo spirito effettua un numero di attacchi pari alla metà del livello dell'incantesimo (arrotondato per difetto)."
- name: "Morso"
...
- name: "Soffio draconico (Ricarica 5-6)"
  desc: "*Tiro salvezza su Destrezza:* CD del tiro salvezza dell'incantesimo dell'incantatore, tutte le creature in un cono di 4,5 metri.\n*Fallimento:* 2d6 + il livello dell'incantesimo danni del tipo scelto.\n*Successo:* danni dimezzati."
bonus_actions: []
reactions: []
legendary_actions: []
lair_actions: []
