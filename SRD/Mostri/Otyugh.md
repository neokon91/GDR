...
actions: 
- name: "Multiattacco"
  desc: "L'otyugh effettua un attacco Morso e due attacchi Tentacolo."
- name: "Morso"
...
- name: "Tentacolo"
  desc: "*Tiro per colpire in mischia:* +6, portata 3 m. *Colpito:* 12 (2d8 + 3) danni perforanti. Se il bersaglio è una creatura di taglia Media o inferiore, è afferrato (CD 13 per sfuggire) da uno dei due tentacoli."
- name: "Schianto con tentacolo"
  desc: "*Tiro salvezza su Costituzione:* CD 14, tutte le creature afferrate dall'otyugh. *Fallimento:* 16 (3d8 + 3) danni contundenti, e il bersaglio è stordito fino all'inizio del turno successivo dell'otyugh. *Successo:* danni dimezzati."
bonus_actions: []
reactions: []
legendary_actions: []
lair_actions: []
