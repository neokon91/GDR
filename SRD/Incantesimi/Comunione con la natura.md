---
id: "srd-comunione_con_la_natura"
srd_id: "comunione_con_la_natura"
...
fonti: ["[[SRD/Licenza SRD]]", "[[SRD/Incantesimi/Comunione con la natura]]"]
riferimenti_srd: ["[[SRD/Incantesimi/Comunione con la natura]]"]
riferimenti_regola: []
sezioni_collegate: []
blocchi_collegati: []
tabelle_collegate: []
...
- Ubicazione di una creatura con grado di sfida pari o superiore a 10 (a scelta del GM) che sia un celestiale, un elementale, un folletto, un immondo o un non morto
