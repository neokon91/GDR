---
id: "srd-combattimenti"
srd_id: "combattimenti"
nome: "Combattimenti"
categoria: "srd"
tipo: "regola"
stato: "pronto"
...
| Voce | Riepilogo |
| --- | --- |
| Facile | Dovrebbe essere vinto senza vittime, pur potendo richiedere risorse di guarigione. |
| Media | Senza cure e risorse puo andare male; possibile eliminazione temporanea e bassa possibilita di morte. |
| Difficile | Puo essere letale e richiede tattiche intelligenti, prontezza e fortuna. |
| Budget PE | Moltiplica il valore per personaggio della tabella per il numero di personaggi, poi spendi PE senza superare il budget. |
| Molte creature | Oltre due creature per personaggio aumenta il rischio di picchi di danno; usa creature deboli, soprattutto ai livelli 1-2. |
